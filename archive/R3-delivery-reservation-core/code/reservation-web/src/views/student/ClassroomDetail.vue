  ...
  <div class="classroom-detail-page" v-loading="loading">
    ...
    <el-card shadow="never" class="info-card">
      <div class="info-head">
        ...
        <el-tag :type="classroom.statusLabel === '使用中' ? 'danger' : 'success'" size="small">
    ...
    <div class="action-bar">
      <el-button type="primary" size="large" :icon="Calendar" @click="openReserveDialog">预约申请</el-button>
    </div>
