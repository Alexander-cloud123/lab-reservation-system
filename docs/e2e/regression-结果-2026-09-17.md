# R1–R5 回归运行结果（2026-09-17 21:55）

- 脚本：`docs/e2e/regression-r1r5.py`
- 命令：`python docs/e2e/regression-r1r5.py`
- 被测版本：`ec83b0e+dirty`（工作区有未提交改动，结果对应未定版代码）
...
| 3 | R5 准备：wangwu 提交教室6/09-18 10-12 预约成功 | PASS | id=43 |
...
| 21 | R5/R3 清理：教室6 09-18 恢复为仅本人 1 个时段 | PASS | slots=1 |
