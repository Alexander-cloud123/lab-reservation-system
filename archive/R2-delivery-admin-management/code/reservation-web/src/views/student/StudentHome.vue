  ...
  <div class="home-page">
    ...
    <main class="home-body">
      <el-card shadow="never" class="welcome-card">
        ...
        <p class="welcome-tip">
          欢迎使用高校实验室预约管理系统。教室浏览、预约申请等功能将在后续迭代上线，当前账号已通过身份校验。
        </p>
        <el-descriptions :column="2" border class="info-table">
          ...
          <el-descriptions-item label="学号">{{ userInfo ? userInfo.studentNo : '-' }}</el-descriptions-item>
          ...
          <el-descriptions-item label="邮箱">{{ userInfo ? userInfo.email : '-' }}</el-descriptions-item>
